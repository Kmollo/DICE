...
# Game state
state = "start"            # Can be "start" or "dice"
dice_number = None         # Final result after roll
rolling = False            # Whether dice is currently spinning
roll_timer = 0             # Timer for animation
...
while running:
    ...
    if state == "start":
        ...
        if rolling:
            ...
            if now - roll_timer > 10000:  # 1 second spin
